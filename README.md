...
**Note:** if you remove "ConsolidationStep" and "ConsolidationFunc" properties from config, webserver will not consolidate datapoints (response exact datapoints received from StatsD). 
